...
class SerialPort():
    ...
    def __init__(self, Port_obj, log_driver):
    ...
    def send_and_read_until(self, cmd, timeout=3, terminator=None):
        self.send_cmd(cmd)
    ...
    def close_port(self):
        if self.port.is_open:
            try:
                ...
                self.log_driver.send_error("Close serial port error: {}".format(self.port_name))
                return False
